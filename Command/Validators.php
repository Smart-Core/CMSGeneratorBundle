...
class Validators
{
    public static function validateBundleNamespace($namespace)
    {
        ...
        */
        ...
        if (false === strpos($namespace, '\\')) {
            ...
            $msg[] = 'If you\'ve specified a vendor namespace, did you forget to surround it with quotes (init:bundle "MySite\BlogModule")?';
    ...
    public static function validateBundleName($bundle)
    {
        ...
        if (!preg_match('/Module$/', $bundle)) {
            throw new \InvalidArgumentException('The bundle name must end with Module.');
        }
